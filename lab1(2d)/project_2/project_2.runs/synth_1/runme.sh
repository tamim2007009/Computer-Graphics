...
HD_PWD='C:/Users/tamim/Desktop/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_adder_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parallel_adder_4bit.tcl
