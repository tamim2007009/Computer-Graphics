...
HD_PWD='C:/Users/tamim/Desktop/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_adder_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parallel_adder_4bit.tcl -notrace
